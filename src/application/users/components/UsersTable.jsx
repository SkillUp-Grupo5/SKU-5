...
export const UsersTable = () => {
	...
	return (
		<Box>
			<SendMoneyModal modalStatus={modalStatus} setModalStatus={setModalStatus} activeUser={activeUser} />
			<Container>
								...
								>
									...
									<StyledTableCell align="right">
										<Tooltip title="Enviar dinero" arrow>
											<IconButton color="default" component="span" onClick={() => handleSendMoney(user)}>
												<AccountBalanceIcon />
											</IconButton>
										</Tooltip>
									</StyledTableCell>
				...
				>
					...
					<Tooltip title="Página siguiente" arrow>
						<IconButton color="primary" component="span" disabled={usersData.nextPage === null ? true : false} onClick={handleNextPage}>
							<ArrowRightIcon />
						</IconButton>
					</Tooltip>
				</Box>
