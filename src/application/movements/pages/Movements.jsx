...
import { useTheme, createTheme, styled, ThemeProvider } from '@mui/material/styles'
							...
							{stableSort(results, getComparator(order, orderBy))
								...
								.map((t) => (
									...
									>
										...
										{t.amount !== 'mount' && sm ? '' : <TableCell align="right">{t.amount}</TableCell>}

										<TableCell align="right">{new Date(t.date).toLocaleString()}</TableCell>
									</TableRow>
								))}
						</TableBody>
					</Table>
